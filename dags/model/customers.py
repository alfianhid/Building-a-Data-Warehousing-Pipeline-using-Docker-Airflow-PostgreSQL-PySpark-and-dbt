...
dataset_url = "https://media.githubusercontent.com/media/alfianhid/Building-a-Data-Warehousing-Pipeline-using-Python-Docker-Airflow-PostgreSQL-and-dbt/master/data/customers_dataset.csv"
columns = ['customer_id',
           'customer_unique_id',
           'customer_zip_code',
           'customer_city',
           'customer_state']
datatypes = {'customer_id': pd.StringDtype,
             'customer_unique_id': pd.StringDtype,
             'customer_zip_code': pd.Int16Dtype,
             'customer_city': pd.StringDtype,
             'customer_state': pd.StringDtype}
