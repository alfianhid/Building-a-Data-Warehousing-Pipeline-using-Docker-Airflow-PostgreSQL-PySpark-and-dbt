...
dataset_url = "https://media.githubusercontent.com/media/alfianhid/Building-a-Data-Warehousing-Pipeline-using-Python-Docker-Airflow-PostgreSQL-and-dbt/master/data/sellers_dataset.csv"
columns = ['seller_id',
           'seller_zip_code',
           'seller_city',
           'seller_state']
