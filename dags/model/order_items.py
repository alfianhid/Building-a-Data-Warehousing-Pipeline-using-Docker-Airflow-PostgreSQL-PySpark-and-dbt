...
dataset_url = "https://media.githubusercontent.com/media/alfianhid/Building-a-Data-Warehousing-Pipeline-using-Python-Docker-Airflow-PostgreSQL-and-dbt/master/data/order_items_dataset.csv"
columns = ['order_id',
           'order_item_id',
           'product_id',
           'seller_id',
